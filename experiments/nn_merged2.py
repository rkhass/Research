...
def get_model(embedding_dim, maxlen):
    ...
    w = layers.Reshape((70, 50, 3))(w)
    w = layers.Conv2D(32, (3, 3), activation='relu')(w)
    w = layers.MaxPooling2D()(w)
    w = layers.Dropout(0.25)(w)

    w = layers.Conv2D(64, (3, 3), activation='relu')(w)
    w = layers.MaxPooling2D()(w)
    w = layers.Dropout(0.25)(w)
...
if __name__ == '__main__':
    ...
    data = pd.read_pickle('data/data.pkl')#.iloc[:50000]
